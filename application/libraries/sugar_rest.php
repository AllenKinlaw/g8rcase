...
class Sugar_REST {
     ...
     */
    private $rest_url = "http://sugarcrm/service/v4_1/rest.php";
     ...
     */
    function Sugar_REST($rest_url = 'http://sugarcrm/service/v4_1/rest.php', $username = null, $password = null, $md5_password = true) {
//        if (!is_null($rest_url)) {
...
//        $sugarsession = $CI->session->userdata('sugarsession');
//        $logged_in = $CI->session->userdata('logged_in');
//        if ($sugarsession && $logged_in) {
//            $this->logged_in = TRUE;
//            $this->session = $sugarsession;
//            return;
//        }
...
//                $data = array('logged_in' => $this->logged_in,
//                    'rest_url' => $this->rest_url,
//                    'username' => $this->username,
//                    'password' => $this->password,
//                    'sugarsession' => $this->session);
//
//                $CI->session->set_userdata($data);
    ...
    public function count_records($module, $query) {
        ...
        $result = $this->rest_request(
                'get_entries_count', $call_arguments
        );
