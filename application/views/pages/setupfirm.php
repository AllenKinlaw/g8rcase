...
<div id="page-wrapper">
    <!--    <div class="row">
     ...
     <div class="hidden-fields">
       <input type="hidden"name='id' value =" <?php echo set_value($this->input->post('id'),$id)?>"/> 
      <input type="hidden" name='name' value =" <?php echo set_value($this->input->post('name'),$name)?>"/>
      <input type="hidden" name= 'account_type' value =" <?php echo set_value($this->input->post('account_type'),$account_type)?>"/>
      <input type="hidden" name= 'office_phone' value =" <?php echo set_value($this->input->post('phone_office'),$phone_office)?>"/>
      <input type="hidden" name= 'ticker_symbol' value =" <?php echo set_value($this->input->post('ticker_symbol'),$ticker_symbol)?>"/>
      <input type="hidden" name= 'billing_address_street' value =" <?php echo set_value($this->input->post('billing_address_street'),$billing_address_street)?>"/>
      <input type="hidden" name= 'billing_address_city' value =" <?php echo set_value($this->input->post('billing_address_city'),$billing_address_city)?>"/>
      <input type="hidden" name= 'billing_address_state' value =" <?php echo set_value($this->input->post('billing_address_state'),$billing_address_state)?>"/>
      <input type="hidden" name= 'billing_address_postalcode' value =" <?php echo set_value($this->input->post('billing_address_postalcode'),$billing_address_postalcode)?>"/>
       </div>
